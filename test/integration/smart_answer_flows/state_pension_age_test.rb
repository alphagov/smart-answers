...
class StatePensionAgeTest < ActiveSupport::TestCase
  ...
  context "age calculation" do
    ...
    context 'gender question' do
      setup do
        add_response Date.parse("5th Dec 1955")
      end
    ...
    context "male, born on 6th April 1945" do
      setup do
    ...
    context "male, born on 5th November 1948" do
      setup do
    ...
    context "male, two days ahead of date in July 2013" do
      setup do
  ...
  context "bus pass age" do
    ...
    should 'ask the dob age' do
      assert_current_node :dob_age?
    end

    context 'born on the 31st of March, 1956' do
      setup do
