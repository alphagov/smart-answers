...
class MarriageAbroadTest < ActiveSupport::TestCase
        ...
        context "partner is british" do
          ...
          context "opposite sex partner" do
            ...
            should "give outcome opposite sex commonwealth" do
              ...
              assert_phrase_list :commonwealth_os_outcome, [:contact_high_comission_of_ceremony_country_in_uk, :get_legal_and_travel_advice, :commonwealth_os_all_cni]
    ...
    context "resident in the ceremony country" do
      ...
      context "partner is local" do
        ...
        context "opposite sex partner" do
          ...
          should "give outcome opposite sex commonwealth" do
            assert_current_node :outcome_os_commonwealth
            assert_phrase_list :commonwealth_os_outcome, [:contact_local_authorities_in_country_marriage, :get_legal_advice, :commonwealth_os_all_cni, :partner_naturalisation_in_uk]
            expected_location = WorldLocation.find('bahamas')
            assert_state_variable :location, expected_location
          end
        end
    ...
    context "resident in 3rd country" do
      ...
      context "partner is local" do
        ...
        context "opposite sex partner" do
          ...
          should "give outcome opposite sex commonwealth" do
            assert_current_node :outcome_os_commonwealth
            assert_phrase_list :commonwealth_os_outcome, [:contact_local_authorities_in_country_marriage, :get_legal_and_travel_advice, :commonwealth_os_all_cni, :partner_naturalisation_in_uk]
            expected_location = WorldLocation.find('bahamas')
            assert_state_variable :location, expected_location
          end
        end
  ...
  context "local resident but ceremony not in zimbabwe" do
    ...
    should "go to commonwealth os outcome" do
      assert_current_node :outcome_os_commonwealth
      assert_phrase_list :commonwealth_os_outcome, [:contact_local_authorities_in_country_marriage, :get_legal_advice, :commonwealth_os_all_cni]
  ...
  context "other resident but ceremony not in zimbabwe" do
    ...
    should "go to commonwealth os outcome" do
      assert_current_node :outcome_os_commonwealth
      assert_phrase_list :commonwealth_os_outcome, [:contact_local_authorities_in_country_marriage, :get_legal_and_travel_advice, :commonwealth_os_all_cni]
    end
  end
  context "ceremony in zimbabwe" do
    ...
    should "go to commonwealth os outcome for uk resident " do
      ...
      add_response 'opposite_sex'
      assert_current_node :outcome_os_commonwealth
      assert_phrase_list :commonwealth_os_outcome, [:contact_zimbabwean_embassy_in_uk, :get_legal_and_travel_advice, :commonwealth_os_all_cni_zimbabwe]
    end
    should "go to commonwealth os outcome for non-uk resident" do
      ...
      add_response 'opposite_sex'
      assert_current_node :outcome_os_commonwealth
      assert_phrase_list :commonwealth_os_outcome, [:contact_local_authorities_in_country_marriage, :get_legal_advice, :commonwealth_os_all_cni_zimbabwe, :partner_naturalisation_in_uk]
    end
  end
  ...
  context "uk resident ceremony in south-africa" do
    ...
    should "go to commonwealth os outcome" do
      assert_current_node :outcome_os_commonwealth
      assert_phrase_list :commonwealth_os_outcome, [:contact_high_comission_of_ceremony_country_in_uk, :get_legal_and_travel_advice, :commonwealth_os_all_cni, :commonwealth_os_other_countries_south_africa, :partner_naturalisation_in_uk]
    end
  end
  context "resident in cyprus, ceremony in cyprus" do
    ...
    should "go to commonwealth os outcome" do
      assert_current_node :outcome_os_commonwealth
      assert_phrase_list :commonwealth_os_outcome, [:contact_local_authorities_in_country_marriage, :get_legal_advice, :commonwealth_os_all_cni, :commonwealth_os_other_countries_cyprus, :partner_naturalisation_in_uk]
    end
  end
  ...
  context "resident in anguilla, ceremony in anguilla" do
    ...
    should "go to bos os outcome" do
      assert_current_node :outcome_os_bot
      assert_phrase_list :bot_outcome, [:bot_os_ceremony_non_biot, :partner_naturalisation_in_uk]
    end
  end
  ...
  context "uk resident, ceremony in estonia, partner british" do
    ...
    should "go to consular cni os outcome" do
      ...
      assert_phrase_list :consular_cni_os_start, [:contact_embassy_of_ceremony_country_in_uk_marriage, :get_legal_and_travel_advice, :what_you_need_to_do, :os_consular_cni_requirement, :cni_at_local_register_office_notary_public, :consular_cni_os_uk_resident_legalisation, :consular_cni_os_uk_resident_not_italy_or_portugal]
  ...
  context "resident in estonia, ceremony in estonia" do
    ...
    should "go to consular cni os outcome" do
      assert_current_node :outcome_os_consular_cni
      assert_phrase_list :consular_cni_os_start, [:contact_local_authorities_in_country_marriage, :get_legal_advice, :what_you_need_to_do, :os_consular_cni_requirement, :consular_cni_os_giving_notice_in_ceremony_country, :embassies_data, :living_in_ceremony_country_3_days, :consular_cni_variant_local_resident_or_foreign_resident_notary_public, :consular_cni_os_not_uk_resident_ceremony_not_germany, :consular_cni_os_other_resident_ceremony_not_germany_or_spain, :consular_cni_os_download_documents_notary_public, :consular_cni_os_foreign_resident_ceremony_notary_public]
      assert_phrase_list :consular_cni_os_remainder, [:consular_cni_os_all_names_but_germany, :consular_cni_os_other_resident_ceremony_not_italy, :partner_naturalisation_in_uk, :no_need_to_stay_after_posting_notice, :consular_cni_os_fees_not_italy_not_uk, :list_of_consular_fees, :pay_by_cash_or_credit_card_no_cheque]
    end
  end
  ...
  context "local resident, ceremony in jordan, partner british" do
    ...
    should "go to consular cni os outcome" do
      assert_current_node :outcome_os_consular_cni
      assert_phrase_list :consular_cni_os_start, [:contact_local_authorities_in_country_marriage, :gulf_states_os_consular_cni, :gulf_states_os_consular_cni_local_resident, :get_legal_advice, :what_you_need_to_do, :consular_cni_os_foreign_resident_21_days_jordan, :consular_cni_os_giving_notice_in_ceremony_country, :embassies_data, :consular_cni_variant_local_resident_jordan, :consular_cni_os_not_uk_resident_ceremony_jordan, :consular_cni_os_other_resident_ceremony_not_germany_or_spain, :consular_cni_os_download_documents_notary_public, :display_notice_of_marriage_7_days]
      assert_phrase_list :consular_cni_os_remainder, [:consular_cni_os_local_resident_ceremony_not_italy_not_germany_partner_british, :consular_cni_os_all_names_but_germany, :consular_cni_os_other_resident_ceremony_not_italy, :no_need_to_stay_after_posting_notice, :consular_cni_os_fees_not_italy_not_uk, :list_of_consular_fees, :pay_by_cash_or_credit_card_no_cheque]
    end
  end
  # variants for italy
  context "ceremony in italy, resident in england, partner british" do
    ...
    should "go to consular cni os outcome" do
      assert_current_node :outcome_os_consular_cni
      assert_phrase_list :consular_cni_os_start, [:italy_os_consular_cni_ceremony_italy, :what_you_need_to_do, :italy_os_consular_cni_uk_resident, :italy_os_consular_cni_uk_resident_two, :cni_at_local_register_office_notary_public, :consular_cni_os_resident_in_uk_ceremony_in_italy]
  ...
  context "ceremony in italy, resident in italy, partner local" do
    ...
    should "go to consular cni os outcome" do
      assert_current_node :outcome_os_consular_cni
      assert_phrase_list :consular_cni_os_start, [:italy_os_consular_cni_ceremony_italy, :what_you_need_to_do, :italy_os_consular_cni_uk_resident_three, :consular_cni_os_local_resident_italy, :consular_cni_variant_local_resident_italy, :italy_consular_cni_os_partner_local, :consular_cni_os_not_uk_resident_ceremony_not_germany, :consular_cni_os_other_resident_ceremony_italy, :wait_300_days_before_remarrying, :consular_cni_os_download_documents_notary_public, :consular_cni_os_foreign_resident_ceremony_notary_public]
      assert_phrase_list :consular_cni_os_remainder, [:consular_cni_os_all_names_but_germany, :partner_naturalisation_in_uk, :no_need_to_stay_after_posting_notice, :consular_cni_os_fees_not_italy_not_uk, :list_of_consular_fees, :pay_by_cash_or_credit_card_no_cheque]
    end
  end
  ...
  context "ceremony in germany, resident in germany, partner other" do
    ...
    should "go to consular cni os outcome" do
      ...
      assert_phrase_list :consular_cni_os_remainder, [:partner_naturalisation_in_uk, :no_need_to_stay_after_posting_notice, :consular_cni_os_fees_not_italy_not_uk, :list_of_consular_fees, :pay_by_cash_or_credit_card_no_cheque]
    end
  end
  context "ceremony in germany, partner german, same sex" do
    ...
    should "go to cp or equivalent outcome" do
      ...
      assert_phrase_list :cp_or_equivalent_cp_outcome, [:cp_or_equivalent_cp_germany, :contact_local_authorities_in_country_cp, :cp_or_equivalent_cp_all_what_you_need_to_do, :partner_naturalisation_in_uk, :cp_or_equivalent_cp_all_fees, :list_of_consular_fees, :pay_by_cash_or_credit_card_no_cheque]
    end
  end
  ...
  context "ceremony in azerbaijan, resident in scotland, partner non-irish" do
    ...
    should "go to consular cni os outcome" do
      assert_current_node :outcome_os_consular_cni
      assert_phrase_list :consular_cni_os_start, [:contact_embassy_of_ceremony_country_in_uk_marriage, :get_legal_and_travel_advice, :what_you_need_to_do, :os_consular_cni_requirement, :cni_at_local_register_office_notary_public, :consular_cni_os_uk_resident_legalisation, :consular_cni_os_uk_resident_not_italy_or_portugal]
      assert_phrase_list :consular_cni_os_remainder, [:consular_cni_os_all_names_but_germany, :partner_naturalisation_in_uk, :consular_cni_os_fees_not_italy_not_uk, :list_of_consular_fees, :pay_by_cash_or_credit_card_no_cheque]
    end
  end
  ...
  context "ceremony in guatemala, resident in wales, partner other" do
    ...
    should "go to consular cni os outcome" do
      assert_current_node :outcome_os_consular_cni
      assert_phrase_list :consular_cni_os_start, [:contact_embassy_of_ceremony_country_in_uk_marriage, :get_legal_and_travel_advice, :what_you_need_to_do, :os_consular_cni_requirement, :cni_at_local_register_office, :consular_cni_os_uk_resident_legalisation, :consular_cni_os_uk_resident_not_italy_or_portugal]
      assert_phrase_list :consular_cni_os_remainder, [:consular_cni_os_all_names_but_germany, :partner_naturalisation_in_uk, :consular_cni_os_fees_not_italy_not_uk, :list_of_consular_fees, :pay_by_cash_or_credit_card_no_cheque]
    end
  end
  ...
  context "ceremony in denmark, resident in denmark, partner other" do
    ...
    should "go to consular cni os outcome" do
      assert_current_node :outcome_os_consular_cni
      assert_phrase_list :consular_cni_os_start, [:contact_local_authorities_in_country_marriage, :get_legal_advice, :what_you_need_to_do, :os_consular_cni_requirement, :consular_cni_os_denmark, :consular_cni_os_giving_notice_in_ceremony_country, :embassies_data, :consular_cni_variant_local_resident_not_germany_or_spain_or_foreign_resident, :consular_cni_os_not_uk_resident_ceremony_not_germany, :consular_cni_os_other_resident_ceremony_not_germany_or_spain, :consular_cni_os_download_documents_notary_public, :display_notice_of_marriage_7_days]
      assert_phrase_list :consular_cni_os_remainder, [:consular_cni_os_all_names_but_germany, :consular_cni_os_other_resident_ceremony_not_italy, :partner_naturalisation_in_uk, :no_need_to_stay_after_posting_notice, :consular_cni_os_fees_not_italy_not_uk, :list_of_consular_fees, :pay_by_cash_or_credit_card_no_cheque]
    end
  end
  ...
  context "ceremony in spain, resident in uk, partner british, opposite sex" do
    ...
    should "go to consular cni os outcome" do
      assert_current_node :outcome_os_consular_cni
      assert_phrase_list :consular_cni_os_start, [:contact_embassy_of_ceremony_country_in_uk_marriage, :spain_os_consular_cni_opposite_sex, :spain_os_consular_civil_registry, :spain_os_consular_cni_not_local_resident, :what_you_need_to_do, :spain_os_consular_cni_two, :cni_at_local_register_office_notary_public, :consular_cni_os_uk_resident_legalisation, :consular_cni_os_uk_resident_not_italy_or_portugal]
  ...
  context "ceremony in spain, resident in spain, partner local" do
    ...
    should "go to consular cni os outcome" do
      ...
      assert_phrase_list :consular_cni_os_remainder, [:consular_cni_os_all_names_but_germany, :consular_cni_os_ceremony_spain, :consular_cni_os_ceremony_spain_two, :partner_naturalisation_in_uk, :no_need_to_stay_after_posting_notice, :consular_cni_os_fees_not_italy_not_uk, :list_of_consular_fees, :pay_by_cash_or_credit_card_no_cheque]
    end
  end
  ...
  context "ceremony in armenia, resident in scotland, partner other" do
    ...
    should "go to consular cni os outcome" do
      assert_current_node :outcome_os_consular_cni
      assert_phrase_list :consular_cni_os_start, [:contact_embassy_of_ceremony_country_in_uk_marriage, :get_legal_and_travel_advice, :what_you_need_to_do, :os_consular_cni_requirement, :cni_at_local_register_office_notary_public, :consular_cni_os_uk_resident_legalisation, :consular_cni_os_uk_resident_not_italy_or_portugal]
      assert_phrase_list :consular_cni_os_remainder, [:consular_cni_os_all_names_but_germany, :partner_naturalisation_in_uk, :consular_cni_os_fees_not_italy_not_uk, :list_of_consular_fees, :pay_in_local_currency_ceremony_country_name]
    end
  end
  ...
  context "ceremony in thailand, resident in scotland, partner other" do
    ...
    should "go to os affirmation outcome" do
      ...
      assert_phrase_list :affirmation_os_outcome, [:contact_embassy_of_ceremony_country_in_uk_marriage, :get_legal_and_travel_advice, :what_you_need_to_do_affirmation, :appointment_for_affidavit, :embassies_data, :affirmation_os_translation_in_local_language_text, :docs_decree_and_death_certificate, :divorced_or_widowed_evidences, :change_of_name_evidence, :partner_equivalent_document_warning, :partner_naturalisation_in_uk, :fee_table_affidavit_55, :list_of_consular_fees, :pay_by_cash_or_credit_card_no_cheque]
    end
  end
  ...
  context "ceremony in colombia, partner colombian national, opposite sex" do
    ...
    should "go to os affirmation outcome" do
      ...
      assert_phrase_list :colombia_os_phraselist, [:contact_embassy_of_ceremony_country_in_uk_marriage, :get_legal_and_travel_advice, :what_you_need_to_do_affirmation, :make_an_appointment_bring_passport_and_pay_55_colombia, :list_of_consular_fees, :pay_by_cash_or_credit_card_no_cheque, :embassies_data, :legalisation_and_translation, :affirmation_os_translation_in_local_language_text, :documents_for_divorced_or_widowed_china_colombia, :change_of_name_evidence, :consular_cni_os_all_names_but_germany, :partner_naturalisation_in_uk]
    end
  end
  ...
  context "ceremony in egypt, resident in egypt, partner british" do
    ...
    should "go to os affirmation outcome" do
      assert_current_node :outcome_os_affirmation
      assert_phrase_list :affirmation_os_outcome, [:contact_local_authorities_in_country_marriage, :get_legal_advice, :what_you_need_to_do, :make_an_appointment, :embassies_data, :docs_decree_and_death_certificate, :change_of_name_evidence, :partner_declaration, :fee_table_45_55, :list_of_consular_fees, :pay_by_cash_or_credit_card_no_cheque]
    end
  end
  ...
  context "ceremony in lebanon, lives elsewhere, partner other" do
    ...
    should "go to os affirmation outcome" do
      assert_current_node :outcome_os_affirmation
      assert_phrase_list :affirmation_os_outcome, [:contact_nearest_embassy_or_consulate_of_ceremony_country, :get_legal_and_travel_advice, :what_you_need_to_do_affirmation, :appointment_for_affidavit, :embassies_data, :affirmation_os_translation_in_local_language_text, :docs_decree_and_death_certificate, :divorced_or_widowed_evidences, :change_of_name_evidence, :partner_equivalent_document_warning, :partner_naturalisation_in_uk, :affirmation_os_all_fees_45_70, :list_of_consular_fees, :pay_by_cash_or_credit_card_no_cheque]
    end
  end
  ...
  context "ceremony in UAE, resident in UAE, partner local" do
    ...
    should "go to os affirmation outcome" do
      assert_current_node :outcome_os_affirmation
      assert_phrase_list :affirmation_os_outcome, [:contact_local_authorities_in_country_marriage, :get_legal_advice, :affirmation_os_uae, :what_you_need_to_do_affirmation_21_days, :appointment_for_affidavit, :embassies_data, :affirmation_os_translation_in_local_language_text, :docs_decree_and_death_certificate, :divorced_or_widowed_evidences, :change_of_name_evidence, :partner_equivalent_document_warning, :partner_naturalisation_in_uk, :affirmation_os_all_fees_45_70, :list_of_consular_fees, :pay_by_cash_or_credit_card_no_cheque]
    end
  end
  ...
  context "ceremony in Oman, resident in Oman, partner local" do
    ...
    should "go to os affirmation outcome" do
      assert_current_node :outcome_os_consular_cni
      assert_phrase_list :consular_cni_os_start, [:contact_local_authorities_in_country_marriage, :gulf_states_os_consular_cni, :gulf_states_os_consular_cni_local_resident, :get_legal_advice, :what_you_need_to_do, :consular_cni_os_ceremony_21_day_requirement, :os_consular_cni_requirement, :consular_cni_os_giving_notice_in_ceremony_country, :embassies_data, :consular_cni_variant_local_resident_not_germany_or_spain_or_foreign_resident, :consular_cni_os_not_uk_resident_ceremony_not_germany, :consular_cni_os_other_resident_ceremony_not_germany_or_spain, :consular_cni_os_download_documents_notary_public, :display_notice_of_marriage_7_days]
    end
  end
  ...
  context "ceremony in Turkey, resident in Turkey, partner other" do
    ...
    should "go to os affirmation outcome" do
      assert_current_node :outcome_os_affirmation
      assert_phrase_list :affirmation_os_outcome, [:contact_local_authorities_in_country_marriage, :get_legal_advice, :what_you_need_to_do, :appointment_for_affidavit, :embassies_data, :complete_affidavit, :download_affidavit, :affirmation_os_legalised_in_turkey, :documents_for_divorced_or_widowed, :affirmation_os_partner_not_british_turkey, :fee_table_affidavit_55, :list_of_consular_fees, :pay_by_cash_or_credit_card_no_cheque]
    end
  end
  ...
  context "ceremony in Ecuador, resident in Ecuador, partner other" do
    ...
    should "go to os affirmation outcome" do
      assert_current_node :outcome_os_affirmation
      assert_phrase_list :affirmation_os_outcome, [:contact_local_authorities_in_country_marriage, :what_you_need_to_do_affirmation, :appointment_for_affidavit, :embassies_data,
 :affirmation_os_translation_in_local_language_text, :documents_for_divorced_or_widowed_ecuador, :partner_equivalent_document_warning, :consular_cni_os_all_names_but_germany, :partner_naturalisation_in_uk, :fee_table_affirmation_55, :list_of_consular_fees, :pay_by_cash_or_credit_card_no_cheque]
    end
  end
  ...
  context "ceremony in Cambodia" do
    ...
    context "resident in Cambodia, partner other" do
      ...
      should "go to os affirmation outcome" do
        assert_current_node :outcome_os_affirmation
        assert_phrase_list :affirmation_os_outcome, [:contact_local_authorities_in_country_marriage, :what_you_need_to_do_affirmation, :appointment_for_affidavit, :embassies_data, :cni_os_partner_local_legislation_documents_for_appointment, :affirmation_os_translation_in_local_language_text, :documents_for_divorced_or_widowed_cambodia, :change_of_name_evidence, :partner_equivalent_document_warning, :partner_naturalisation_in_uk, :consular_cni_os_all_names_but_germany, :fee_table_affirmation_55, :pay_by_cash_or_us_dollars_only]
      end
    end
  ...
  context "ceremony in aruba, resident in scotland, partner other" do
    ...
    should "go to consular cni os outcome" do
      assert_current_node :outcome_os_consular_cni
      assert_phrase_list :consular_cni_os_start, [:contact_dutch_embassy_for_dutch_caribbean_islands, :get_legal_and_travel_advice, :what_you_need_to_do, :os_consular_cni_requirement, :cni_at_local_register_office, :consular_cni_os_uk_resident_legalisation, :consular_cni_os_uk_resident_not_italy_or_portugal]
      assert_phrase_list :consular_cni_os_remainder, [:consular_cni_os_all_names_but_germany, :partner_naturalisation_in_uk, :consular_cni_os_fees_not_italy_not_uk]
    end
  end
  ...
  context "user lives in macedonia, ceremony in macedonia" do
    ...
    should "go to consular cni os outcome" do
      assert_current_node :outcome_os_consular_cni
      assert_phrase_list :consular_cni_os_start, [:contact_local_authorities_in_country_marriage, :get_legal_advice, :what_you_need_to_do, :os_consular_cni_requirement, :consular_cni_os_foreign_resident_3_days_macedonia, :living_in_ceremony_country_3_days, :consular_cni_variant_local_resident_or_foreign_resident_notary_public, :consular_cni_os_not_uk_resident_ceremony_not_germany, :consular_cni_os_other_resident_ceremony_not_germany_or_spain, :consular_cni_os_download_documents_notary_public, :display_notice_of_marriage_7_days]
    end
  end
  ...
  context "ceremony in spain, resident in england, partner british, same sex" do
    ...
    should "go to cp or equivalent outcome" do
      assert_current_node :outcome_os_consular_cni
      assert_phrase_list :consular_cni_os_start, [:contact_embassy_of_ceremony_country_in_uk_marriage, :spain_os_consular_cni_same_sex, :spain_os_consular_civil_registry, :spain_os_consular_cni_not_local_resident, :what_you_need_to_do, :spain_os_consular_cni_two, :cni_at_local_register_office_notary_public, :consular_cni_os_uk_resident_legalisation, :consular_cni_os_uk_resident_not_italy_or_portugal, :consular_cni_os_download_documents_notary_public]
      assert_phrase_list :consular_cni_os_remainder, [:consular_cni_os_local_resident_ceremony_not_italy_not_germany_partner_british, :consular_cni_os_all_names_but_germany, :consular_cni_os_ceremony_spain, :consular_cni_os_ceremony_spain_partner_british, :consular_cni_os_ceremony_spain_two, :consular_cni_os_fees_not_italy_not_uk, :list_of_consular_fees, :pay_by_cash_or_credit_card_no_cheque]
    end
  end
  ...
  context "ceremony in russia, resident in russia, partner british" do
    ...
    should "go to russia CNI outcome" do
      assert_current_node :outcome_os_consular_cni
      assert_phrase_list :consular_cni_os_start, [:contact_local_authorities_in_country_marriage, :get_legal_advice, :what_you_need_to_do, :os_consular_cni_requirement, :russia_os_local_resident, :consular_cni_variant_local_resident_or_foreign_resident_notary_public, :consular_cni_os_not_uk_resident_ceremony_not_germany, :consular_cni_os_other_resident_ceremony_not_germany_or_spain, :consular_cni_os_download_documents_notary_public, :consular_cni_os_foreign_resident_ceremony_notary_public]
      assert_phrase_list :consular_cni_os_remainder, [:consular_cni_os_all_names_but_germany, :consular_cni_os_other_resident_ceremony_not_italy, :partner_naturalisation_in_uk, :no_need_to_stay_after_posting_notice, :consular_cni_os_fees_not_italy_not_uk, :list_of_consular_fees, :consular_cni_os_fees_russia]
    end
  end
  ...
  context "ceremony in denmark, resident in england, partner other" do
    ...
    should "go to cp or equivalent outcome" do
      assert_current_node :outcome_cp_cp_or_equivalent
      assert_phrase_list :cp_or_equivalent_cp_outcome, [:cp_or_equivalent_cp_denmark, :contact_embassy_of_ceremony_country_in_uk_cp, :also_check_travel_advice, :cp_or_equivalent_cp_all_what_you_need_to_do, :partner_naturalisation_in_uk, :cp_or_equivalent_cp_all_fees, :list_of_consular_fees, :pay_by_cash_or_credit_card_no_cheque]
    end
  end
  ...
  context "ceremony in czech republic, lives elsewhere, partner local" do
    ...
    should "go to cp or equivalent outcome" do
      ...
      assert_phrase_list :cp_or_equivalent_cp_outcome, [:"cp_or_equivalent_cp_czech-republic", :cp_or_equivalent_cp_other_resident, :also_check_travel_advice, :partner_naturalisation_in_uk]
      assert_state_variable :pay_by_cash_or_credit_card_no_cheque, nil
    end
  end
  ...
  context "ceremony in sweden, resident in sweden, partner other" do
    ...
    should "go to cp or equivalent os outcome" do
      assert_current_node :outcome_cp_cp_or_equivalent
      assert_phrase_list :cp_or_equivalent_cp_outcome, [:cp_or_equivalent_cp_sweden, :contact_local_authorities_in_country_cp, :cp_or_equivalent_cp_all_what_you_need_to_do, :partner_naturalisation_in_uk, :cp_or_equivalent_cp_all_fees, :list_of_consular_fees, :pay_by_cash_or_credit_card_no_cheque]
    end
  end
  ...
  context "ceremony in US, resident in ni, partner local" do
    ...
    should "go to cp no cni required outcome" do
      ...
      assert_phrase_list :no_cni_required_cp_outcome, [:"no_cni_required_cp_usa", :get_legal_advice, :no_cni_required_cp_ceremony_us, :what_you_need_to_do, :no_cni_required_cp_not_dutch_islands_uk_resident, :no_cni_required_cp_all_consular_facilities, :partner_naturalisation_in_uk]
    end
  end
  ...
  context "ceremony in bonaire, resident in scotland, partner other" do
    ...
    should "go to cp no cni required outcome" do
      assert_current_node :outcome_cp_no_cni
      assert_phrase_list :no_cni_required_cp_outcome, [:"no_cni_required_cp_bonaire-st-eustatius-saba", :get_legal_advice, :what_you_need_to_do, :no_cni_required_cp_dutch_islands, :no_cni_required_cp_dutch_islands_uk_resident, :no_cni_required_cp_all_consular_facilities, :partner_naturalisation_in_uk]
    end
  end
  ...
  context "ceremony in bonaire, resident in bonaire, partner british" do
    ...
    should "go to cp no cni required outcome" do
      assert_current_node :outcome_cp_no_cni
      assert_phrase_list :no_cni_required_cp_outcome, [:"no_cni_required_cp_bonaire-st-eustatius-saba", :get_legal_advice, :what_you_need_to_do, :no_cni_required_cp_dutch_islands, :contact_local_authorities_in_country_cp, :no_cni_required_cp_all_consular_facilities]
    end
  end
  ...
  context "ceremony in bonaire, resident in mexico, partner other" do
    ...
    should "go to cp no cni required outcome" do
      assert_current_node :outcome_cp_no_cni
      assert_phrase_list :no_cni_required_cp_outcome, [:"no_cni_required_cp_bonaire-st-eustatius-saba", :get_legal_advice, :what_you_need_to_do, :no_cni_required_cp_dutch_islands, :no_cni_required_cp_dutch_islands_other_resident, :no_cni_required_cp_all_consular_facilities, :partner_naturalisation_in_uk]
    end
  end
  ...
  context "ceremony in czech-republic, uk resident, partner other" do
    ...
    should "go to consular cni cp countries outcome" do
      assert_current_node :outcome_cp_cp_or_equivalent
      assert_phrase_list :cp_or_equivalent_cp_outcome, [:"cp_or_equivalent_cp_czech-republic", :contact_embassy_of_ceremony_country_in_uk_cp, :also_check_travel_advice, :partner_naturalisation_in_uk]
      assert_state_variable :pay_by_cash_or_credit_card_no_cheque, nil
    end
  end
  ...
  context "ceremony in italy, resident in channel islands" do
    ...
    should "go to iom/ci os outcome" do
      ...
      assert_phrase_list :iom_ci_os_outcome, [:contact_local_authorities_in_country_marriage, :iom_ci_os_resident_of_ci, :iom_ci_os_ceremony_italy]
    end
  end
  #testing for china
  context "ceremony in china, partner is not from china, opposite sex" do
    should "render address from API" do
      ...
      add_response 'opposite_sex'
      assert_current_node :outcome_os_affirmation
      assert_phrase_list :affirmation_os_outcome, [:contact_embassy_of_ceremony_country_in_uk_marriage, :get_legal_and_travel_advice, :what_you_need_to_do, :book_online_china_non_local_prelude, :book_online_china_affirmation_affidavit, :embassies_data, :documents_for_divorced_or_widowed_china_colombia, :change_of_name_evidence, :affirmation_affidavit_os_partner, :affirmation_os_all_fees_45_70, :list_of_consular_fees, :pay_by_cash_or_credit_card_no_cheque]
    end
  end
  ...
  context "ceremony in china, partner is national of china" do
    should "render address from API" do
      ...
      add_response 'opposite_sex'
      assert_current_node :outcome_os_affirmation
      assert_phrase_list :affirmation_os_outcome, [:contact_local_authorities_in_country_marriage, :get_legal_advice, :what_you_need_to_do, :book_online_china_local_prelude, :book_online_china_affirmation_affidavit, :embassies_data, :documents_for_divorced_or_widowed_china_colombia, :change_of_name_evidence, :partner_equivalent_document_warning, :partner_naturalisation_in_uk, :affirmation_os_all_fees_45_70, :list_of_consular_fees, :pay_by_cash_or_credit_card_no_cheque]
    end
  end
  #testing for japan
  context "ceremony in Japan" do
    ...
    context "opposite sex UK residents" do
      ...
      should "have a japan-specific intro" do
        assert_current_node :outcome_os_consular_cni
        assert_phrase_list :consular_cni_os_start, [:japan_intro, :what_you_need_to_do, :os_consular_cni_requirement, :cni_at_local_register_office_notary_public, :consular_cni_os_uk_resident_legalisation, :consular_cni_os_uk_resident_not_italy_or_portugal]
      end
    end
  ...
  context "ceremony in finland, resident in the UK, partner british" do
    ...
    should "go to cni outcome" do
      ...
      assert_phrase_list :consular_cni_os_start, [:contact_embassy_of_ceremony_country_in_uk_marriage, :get_legal_and_travel_advice, :what_you_need_to_do, :os_consular_cni_requirement, :cni_at_local_register_office, :consular_cni_os_uk_legalisation_check_with_authorities, :consular_cni_os_uk_resident_not_italy_or_portugal]
     end
  end
  ...
  context "ceremony in finland, resident in the UK, partner local" do
    ...
    should "go to cni outcome" do
      assert_current_node :outcome_os_consular_cni
      assert_phrase_list :consular_cni_os_remainder, [:consular_cni_os_all_names_but_germany, :partner_naturalisation_in_uk, :consular_cni_os_fees_not_italy_not_uk, :list_of_consular_fees, :pay_in_euros_or_visa_electron]
      assert_phrase_list :consular_cni_os_start, [:contact_embassy_of_ceremony_country_in_uk_marriage, :get_legal_and_travel_advice, :what_you_need_to_do, :os_consular_cni_requirement, :cni_at_local_register_office, :consular_cni_os_uk_legalisation_check_with_authorities, :consular_cni_os_uk_resident_not_italy_or_portugal]
     end
  end
  ...
  context "ceremony in finland, resident in Australia, partner other" do
    ...
    should "go to affirmation outcome with specific fee table" do
      assert_current_node :outcome_os_affirmation
      assert_phrase_list :affirmation_os_outcome, [:contact_nearest_embassy_or_consulate_of_ceremony_country, :get_legal_and_travel_advice, :what_you_need_to_do_affirmation, :appointment_for_affidavit, :embassies_data, :affirmation_os_translation_in_local_language_text, :docs_decree_and_death_certificate, :divorced_or_widowed_evidences, :change_of_name_evidence, :partner_equivalent_document_warning, :partner_naturalisation_in_uk, :fee_table_affirmation_65, :list_of_consular_fees, :pay_in_euros_or_visa_electron]
    end
  end
  ...
  context "ceremony in finland, resident in the UK, partner other" do
    ...
    should "go to outcome cni with specific fee table" do
      assert_current_node :outcome_os_consular_cni
      assert_phrase_list :consular_cni_os_remainder, [:callout_partner_equivalent_document, :consular_cni_os_all_names_but_germany, :partner_naturalisation_in_uk, :consular_cni_os_fees_not_italy_not_uk, :list_of_consular_fees, :pay_in_euros_or_visa_electron]
      assert_phrase_list :consular_cni_os_start, [:contact_embassy_of_ceremony_country_in_uk_marriage, :get_legal_and_travel_advice, :what_you_need_to_do, :os_consular_cni_requirement, :cni_at_local_register_office, :consular_cni_os_uk_legalisation_check_with_authorities, :consular_cni_os_uk_resident_not_italy_or_portugal]
    end
  end
  ...
  context "ceremony in finland, resident in the UK, partner other, SS" do
    ...
    should "go to affirmation outcome with specific fee table" do
      assert_current_node :outcome_cp_cp_or_equivalent
      assert_phrase_list :cp_or_equivalent_cp_outcome, [:cp_or_equivalent_cp_finland, :contact_embassy_of_ceremony_country_in_uk_cp, :also_check_travel_advice, :cp_or_equivalent_cp_all_what_you_need_to_do, :partner_naturalisation_in_uk, :cp_or_equivalent_cp_all_fees, :list_of_consular_fees, :pay_by_cash_or_credit_card_no_cheque]
    end
  end
  ...
  context "south-korea new outcome" do
    should "go to outcome os affirmation with new korea phraselist" do
      ...
      add_response 'opposite_sex'
      assert_current_node :outcome_os_affirmation
      assert_phrase_list :affirmation_os_outcome, [:contact_embassy_of_ceremony_country_in_uk_marriage, :get_legal_and_travel_advice, :what_you_need_to_do_affirmation, :appointment_for_affidavit, :embassies_data, :affirmation_os_translation_in_local_language_text, :docs_decree_and_death_certificate, :divorced_or_widowed_evidences, :change_of_name_evidence, :affirmation_os_partner_british, :fee_table_affidavit_55, :list_of_consular_fees, :pay_by_cash_or_credit_card_no_cheque]
    end
  end
  ...
  context "ceremony in philippines, uk resident, partner other" do
    ...
    should "go to os affirmation outcome" do
      assert_phrase_list :affirmation_os_outcome, [:contact_embassy_of_ceremony_country_in_uk_marriage, :get_legal_and_travel_advice, :what_you_need_to_do_affirmation, :contact_for_affidavit, :make_appointment_online_philippines, :embassies_data, :affirmation_os_translation_in_local_language_text, :affirmation_os_download_affidavit_philippines, :docs_decree_and_death_certificate, :divorced_or_widowed_evidences, :change_of_name_evidence, :partner_equivalent_document_warning, :partner_naturalisation_in_uk, :fee_table_55_70, :list_of_consular_fees, :pay_in_cash_or_manager_cheque]
    end
  end
  ...
  context "Marrying in Qatar" do
    ...
    should "go to outcome_os_consular_cni and show specific phraselist for OS marriage of residents in a 3rd country" do
      ...
      add_response 'opposite_sex'
      assert_current_node :outcome_os_affirmation
      assert_phrase_list :affirmation_os_outcome, [:contact_local_authorities_in_country_marriage, :gulf_states_os_consular_cni, :gulf_states_os_consular_cni_local_resident, :get_legal_and_travel_advice, :what_you_need_to_do_affirmation_21_days, :appointment_for_affidavit, :embassies_data, :affirmation_os_translation_in_local_language_text, :docs_decree_and_death_certificate, :divorced_or_widowed_evidences, :change_of_name_evidence, :partner_equivalent_document_warning, :partner_naturalisation_in_uk, :fee_table_45_70_55, :list_of_consular_fees, :pay_by_cash_or_credit_card_no_cheque]
    end
  end
  ...
  context "test morocco specific phraselists, living in the UK" do
    ...
    should "go to os affirmation outcome" do
      assert_current_node :outcome_os_affirmation
      assert_phrase_list :affirmation_os_outcome, [:contact_embassy_of_ceremony_country_in_uk_marriage, :contact_laadoul, :get_legal_and_travel_advice, :what_you_need_to_do_affirmation, :appointment_for_affidavit, :embassies_data, :affirmation_os_translation_in_local_language_text, :documents_for_divorced_or_widowed, :morocco_affidavit_length, :partner_equivalent_document, :fee_table_affirmation_55, :list_of_consular_fees, :pay_by_cash_or_credit_card_no_cheque]
    end
  end
  ...
  context "test morocco specific phraselists, living elsewhere" do
    ...
    should "go to os affirmation outcome" do
      assert_current_node :outcome_os_affirmation
      assert_phrase_list :affirmation_os_outcome, [:contact_nearest_embassy_or_consulate_of_ceremony_country, :contact_laadoul, :get_legal_and_travel_advice, :what_you_need_to_do_affirmation, :appointment_for_affidavit, :embassies_data, :affirmation_os_translation_in_local_language_text, :documents_for_divorced_or_widowed, :morocco_affidavit_length, :partner_equivalent_document, :fee_table_affirmation_55, :list_of_consular_fees, :pay_by_cash_or_credit_card_no_cheque]
    end
  end
