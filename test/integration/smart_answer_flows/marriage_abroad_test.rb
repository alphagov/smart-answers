...
class MarriageAbroadTest < ActiveSupport::TestCase
  ...
  FLATTEN_COUNTRIES_18_OUTCOMES = %w(algeria austria azerbaijan brazil british-indian-ocean-territory burma cambodia chile colombia denmark el-salvador ethiopia the-gambia germany hungary indonesia iran jordan kenya kuwait latvia malaysia maldives moldova montenegro morocco mozambique nicaragua panama portugal oman romania russia sweden tanzania tunisia uganda vietnam).freeze
  ...
  context "Montenegro" do
    ...
    should "lead to outcome_marriage_abroad_in_country when both partners are same sex british" do
      add_response 'partner_british'
      add_response 'same_sex'
      assert_current_node :outcome_marriage_abroad_in_country
    end

    should "lead to outcome_marriage_abroad_in_country when both partners are same sex not british" do
      add_response 'partner_local'
      add_response 'same_sex'
      assert_current_node :outcome_marriage_abroad_in_country
    end
