...
class MarriageAbroadTest < ActiveSupport::TestCase
  ...
  context "resident in cyprus, ceremony in cyprus" do
    ...
    should "go to commonwealth os outcome" do
      assert_current_node :outcome_os_commonwealth
      assert_phrase_list :commonwealth_os_outcome, [:contact_local_authorities_in_country, :get_legal_advice, :get_travel_advice_unless_local, :commonwealth_os_all_cni, :commonwealth_os_other_countries_cyprus, :commonwealth_os_naturalisation]
    end
  end
  ...
  context "uk resident, ceremony in estonia, partner british" do
    ...
    should "go to consular cni os outcome" do
      ...
      assert_phrase_list :consular_cni_os_start, [:contact_embassy_of_ceremony_country_in_uk, :get_legal_and_travel_advice, :consular_cni_all_what_you_need_to_do, :os_consular_cni_requirement, :cni_at_local_register_office_notary_public, :consular_cni_os_uk_resident_legalisation, :consular_cni_os_uk_resident_not_italy_or_portugal]
  ...
  context "ceremony in germany, resident in germany, partner other" do
    ...
    should "go to consular cni os outcome" do
      assert_current_node :outcome_os_consular_cni
      assert_phrase_list :consular_cni_os_start, [:contact_local_authorities_in_country, :get_legal_advice, :consular_cni_all_what_you_need_to_do, :consular_cni_os_german_resident, :consular_cni_os_ceremony_germany_not_uk_resident]
  ...
  context "ceremony in guatemala, resident in wales, partner other" do
    ...
    should "go to consular cni os outcome" do
      assert_current_node :outcome_os_consular_cni
      assert_phrase_list :consular_cni_os_start, [:contact_embassy_of_ceremony_country_in_uk, :get_legal_and_travel_advice, :consular_cni_all_what_you_need_to_do, :os_consular_cni_requirement, :cni_at_local_register_office, :consular_cni_os_uk_resident_legalisation, :consular_cni_os_uk_resident_not_italy_or_portugal]
      assert_phrase_list :consular_cni_os_remainder, [:consular_cni_os_all_names_but_germany, :consular_cni_os_naturalisation, :consular_cni_os_fees_not_italy_not_uk, :list_of_consular_fees, :pay_by_cash_or_credit_card_no_cheque]
    end
  end
  ...
  context "ceremony in spain, resident in uk, partner british, opposite sex" do
    ...
    should "go to consular cni os outcome" do
      assert_current_node :outcome_os_consular_cni
      assert_phrase_list :consular_cni_os_start, [:contact_embassy_of_ceremony_country_in_uk, :spain_os_consular_cni_opposite_sex, :spain_os_consular_civil_registry, :spain_os_consular_cni_not_local_resident, :consular_cni_all_what_you_need_to_do, :spain_os_consular_cni_two, :cni_at_local_register_office_notary_public, :consular_cni_os_uk_resident_legalisation, :consular_cni_os_uk_resident_not_italy_or_portugal]
  ...
  context "ceremony in spain, resident in spain, partner local" do
    ...
    should "go to consular cni os outcome" do
      assert_current_node :outcome_os_consular_cni
      assert_phrase_list :consular_cni_os_start, [:contact_local_authorities_in_country, :spain_os_consular_cni_opposite_sex, :spain_os_consular_civil_registry, :consular_cni_all_what_you_need_to_do, :spain_os_consular_cni_two, :consular_cni_os_foreign_resident_ceremony_not_germany_italy, :check_with_embassy_consulate_or_notary_public, :consular_cni_variant_local_resident_spain, :consular_cni_os_not_uk_resident_ceremony_not_germany, :spain_os_consular_cni_three]
  ...
  context "ceremony in thailand, resident in scotland, partner other" do
    ...
    should "go to os affirmation outcome" do
      ...
      assert_phrase_list :affirmation_os_outcome, [:affirmation_os_uk_resident, :get_legal_advice, :what_you_need_to_do_affirmation, :appointment_for_affidavit, :embassies_data, :affirmation_os_translation_in_local_language_text, :docs_decree_and_death_certificate, :divorced_or_widowed_evidences, :change_of_name_evidence, :partner_equivalent_document_warning, :affirmation_os_partner_not_british, :fee_table_affidavit_55, :list_of_consular_fees, :pay_by_cash_or_credit_card_no_cheque]
    end
  end
  ...
  context "ceremony in egypt, resident in egypt, partner british" do
    ...
    should "go to os affirmation outcome" do
      assert_current_node :outcome_os_affirmation
      assert_phrase_list :affirmation_os_outcome, [:affirmation_os_local_resident, :get_legal_advice, :what_you_need_to_do, :make_an_appointment, :embassies_data, :docs_decree_and_death_certificate, :change_of_name_evidence, :partner_declaration, :fee_table_45_55, :list_of_consular_fees, :pay_by_cash_or_credit_card_no_cheque]
    end
  end
  ...
  context "ceremony in lebanon, lives elsewhere, partner other" do
    ...
    should "go to os affirmation outcome" do
      assert_current_node :outcome_os_affirmation
      assert_phrase_list :affirmation_os_outcome, [:affirmation_os_other_resident, :get_legal_advice, :what_you_need_to_do_affirmation, :appointment_for_affidavit, :embassies_data, :affirmation_os_translation_in_local_language_text, :docs_decree_and_death_certificate, :divorced_or_widowed_evidences, :change_of_name_evidence, :partner_equivalent_document_warning, :affirmation_os_partner_not_british, :affirmation_os_all_fees_45_70, :list_of_consular_fees, :pay_by_cash_or_credit_card_no_cheque]
    end
  end
  ...
  context "ceremony in Turkey, resident in Scotland, partner local" do
    ...
    should "go to os affirmation outcome" do
      assert_current_node :outcome_os_affirmation
      assert_phrase_list :affirmation_os_outcome, [:affirmation_os_uk_resident, :get_legal_advice, :what_you_need_to_do, :appointment_for_affidavit_notary, :complete_affidavit, :download_affidavit, :affirmation_os_legalised, :documents_for_divorced_or_widowed, :affirmation_os_partner_not_british_turkey, :fee_table_affidavit_55, :list_of_consular_fees, :pay_by_cash_or_credit_card_no_cheque]
    end
  end
 ...
 :affirmation_os_translation_in_local_language_text, :documents_for_divorced_or_widowed_ecuador, :partner_equivalent_document_warning, :consular_cni_os_all_names_but_germany, :affirmation_os_partner_not_british, :fee_table_affirmation_55, :list_of_consular_fees, :pay_by_cash_or_credit_card_no_cheque]
  ...
  context "ceremony in bonaire, resident in bonaire, partner british" do
    ...
    should "go to cp no cni required outcome" do
      assert_current_node :outcome_cp_no_cni
      assert_phrase_list :no_cni_required_cp_outcome, [:"no_cni_required_cp_bonaire-st-eustatius-saba", :get_legal_advice, :no_cni_required_all_what_you_need_to_do, :no_cni_required_cp_dutch_islands, :no_cni_required_cp_dutch_islands_local_resident, :no_cni_required_cp_all_consular_facilities]
    end
  end
  ...
  context "ceremony in finland, resident in the UK, partner british" do
    ...
    should "go to cni outcome" do
      ...
      assert_phrase_list :consular_cni_os_start, [:contact_embassy_of_ceremony_country_in_uk, :get_legal_and_travel_advice, :consular_cni_all_what_you_need_to_do, :os_consular_cni_requirement, :cni_at_local_register_office, :consular_cni_os_uk_legalisation_check_with_authorities, :consular_cni_os_uk_resident_not_italy_or_portugal]
     end
  end
  ...
  context "ceremony in finland, resident in Australia, partner other" do
    ...
    should "go to affirmation outcome with specific fee table" do
      assert_current_node :outcome_os_affirmation
      assert_phrase_list :affirmation_os_outcome, [:affirmation_os_other_resident, :get_legal_advice, :what_you_need_to_do_affirmation, :appointment_for_affidavit, :embassies_data, :affirmation_os_translation_in_local_language_text, :docs_decree_and_death_certificate, :divorced_or_widowed_evidences, :change_of_name_evidence, :partner_equivalent_document_warning, :affirmation_os_partner_not_british, :fee_table_affirmation_65, :list_of_consular_fees, :pay_in_euros_or_visa_electron]
    end
  end
  ...
  context "south-korea new outcome" do
    should "go to outcome os affirmation with new korea phraselist" do
      ...
      add_response 'opposite_sex'
      assert_current_node :outcome_os_affirmation
      assert_phrase_list :affirmation_os_outcome, [:affirmation_os_uk_resident, :get_legal_advice, :what_you_need_to_do_affirmation, :appointment_for_affidavit, :embassies_data, :affirmation_os_translation_in_local_language_text, :docs_decree_and_death_certificate, :divorced_or_widowed_evidences, :change_of_name_evidence, :affirmation_os_partner_british, :fee_table_affidavit_55, :list_of_consular_fees, :pay_by_cash_or_credit_card_no_cheque]
    end
  end
  ...
  context "ceremony in philippines, uk resident, partner other" do
    ...
    should "go to os affirmation outcome" do
      assert_phrase_list :affirmation_os_outcome, [:affirmation_os_uk_resident, :get_legal_advice, :what_you_need_to_do_affirmation, :contact_for_affidavit, :make_appointment_online_philippines, :embassies_data, :affirmation_os_translation_in_local_language_text, :affirmation_os_download_affidavit_philippines, :docs_decree_and_death_certificate, :divorced_or_widowed_evidences, :change_of_name_evidence, :partner_equivalent_document_warning, :affirmation_os_partner_not_british, :fee_table_55_70, :list_of_consular_fees, :pay_in_cash_or_manager_cheque]
    end
  end
  ...
  context "opposite sex marriage to local partner in Brazil" do
    ...
    should "divert to the correct download link for the Affidavit for Marriage document" do
      ...
      assert_phrase_list :brazil_phraselist_not_in_the_uk, [:contact_local_authorities_in_country, :get_legal_and_travel_advice, :what_you_need_to_do, :make_an_appointment_bring_passport_and_pay_55_brazil, :list_of_consular_fees, :pay_by_cash_or_credit_card_no_cheque, :embassies_data, :download_affidavit_forms_but_do_not_sign, :download_affidavit_brazil, :documents_for_divorced_or_widowed, :affirmation_os_partner_not_british_turkey]
    end
  end
