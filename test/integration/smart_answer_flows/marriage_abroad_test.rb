...
class MarriageAbroadTest < ActiveSupport::TestCase
  ...
  FLATTEN_COUNTRIES_2_OUTCOMES = %w[australia croatia cyprus egypt france india ireland luxembourg philippines south-africa south-korea south-korea thailand turkey usa zimbabwe].freeze
  ...
  context "country offers consular opposite sex civil partnerships" do
    context "japan" do
      setup do
        add_response "japan"
      end
      context "opposite sex" do
        ...
        context "civil partnership" do
          setup { add_response "civil_partnership" }
          should "go to opposite sex civil partnership japan outcome" do
            assert_current_node :outcome_opposite_sex_civil_partnership_in_japan
          end
        end
        context "marriage" do
      ...
      context "resident in uk," do
        ...
        context "partner is british," do
          ...
          context "opposite sex" do
            ...
            context "civil_partnership" do
              setup { add_response "civil_partnership" }
              should "go to opposite sex civil partnership vietnam outcome" do
                assert_current_node :outcome_opposite_sex_civil_partnership_in_vietnam
              end
            end
          end
          context "same sex" do
      ...
      context "resident in uk," do
        ...
        context "partner is british," do
          ...
          context "opposite sex" do
            ...
            context "civil_partnership" do
              setup { add_response "civil_partnership" }
              should "go to opposite sex civil partnership panama outcome" do
                assert_current_node :outcome_opposite_sex_civil_partnership_in_panama
              end
            end
          end
          context "same sex" do
