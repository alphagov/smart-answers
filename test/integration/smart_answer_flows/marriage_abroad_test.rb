...
class MarriageAbroadTest < ActiveSupport::TestCase
  ...
  FLATTEN_COUNTRIES_18_OUTCOMES = %w(algeria austria azerbaijan brazil british-indian-ocean-territory burma cambodia chile colombia denmark el-salvador ethiopia the-gambia germany hungary indonesia iran jordan kenya kuwait latvia malaysia maldives moldova montenegro morocco mozambique nicaragua oman portugal qatar romania russia sweden tanzania tunisia uganda vietnam).freeze
