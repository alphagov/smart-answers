...
class MarriageAbroadTest < ActiveSupport::TestCase
  ...
  FLATTEN_COUNTRIES_18_OUTCOMES = %w(algeria azerbaijan brazil british-indian-ocean-territory burma cambodia chile colombia denmark el-salvador ethiopia the-gambia germany hungary indonesia iran jordan kenya kuwait latvia maldives moldova montenegro mozambique nicaragua portugal romania russia sweden tanzania tunisia uganda vietnam).freeze
