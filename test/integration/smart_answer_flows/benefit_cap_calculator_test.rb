...
class BenefitCapCalculatorTest < ActiveSupport::TestCase
  ...
  context "Benefit cap calculator" do
    should "ask whether you want to check your situation using pre or post Autumn 2016 changes" do
      assert_current_node :choose_cap_to_calculate?
    end

    context "when using pre-Autumn 2016 rates and rules" do
