...
require "smart_answer_flows/business-coronavirus-risk-assessment.rb"

class BusinessCoronavirusRiskAssessmentFlowTest < ActiveSupport::TestCase
  include FlowTestHelper

  setup do
    setup_for_testing_flow SmartAnswer::BusinessCoronavirusRiskAssessmentFlow
  end
