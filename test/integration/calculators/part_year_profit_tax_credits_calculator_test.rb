...
module SmartAnswer
  class PartYearProfitTaxCreditsCalculatorTest < ActiveSupport::TestCase
    context 'tax credits finish in 2018/19 tax year for an ongoing business with accounting period aligned to the tax year' do
      setup do
      ...
      should "use the 2018/19 tax year" do
    ...
    context 'tax credits finish in 2018/19 tax year for an ongoing business with accounting period aligned to the calendar year' do
      setup do
        @calculator = Calculators::PartYearProfitTaxCreditsCalculator.new
      ...
      should "use the accounting period from 1st Jan to 31st Dec 2018" do
        expected_accounting_year = YearRange.new(
          begins_on: Date.parse('2018-01-01')
        )
        assert_equal expected_accounting_year, @calculator.accounting_year
        assert_equal 365, @calculator.accounting_year.number_of_days
      end
    ...
    context 'tax credits finish in 2018/19 tax year, business stops trading before the award date, business accounts align to tax year' do
      setup do
        @calculator = Calculators::PartYearProfitTaxCreditsCalculator.new
    ...
    context 'tax credits finish in 2018/19 tax year, business stops trading before the award date, business accounting date falls between start of tax year and stopped trading date' do
      setup do
        @calculator = Calculators::PartYearProfitTaxCreditsCalculator.new
      ...
      should "use the accounting period that ends in the 2018/19 tax year" do
        expected_accounting_year = YearRange.new(
          begins_on: Date.parse('2017-06-01')
        )
        assert_equal expected_accounting_year, @calculator.accounting_year
      end
    ...
    context 'tax credits finish in 2018/19 tax year, business stops trading before the award date, business accounting date falls between the stopped trading date and end of the tax year' do
      setup do
        @calculator = Calculators::PartYearProfitTaxCreditsCalculator.new
      ...
      should "use the accounting period that ends in the 2018/19 tax year" do
        expected_accounting_year = YearRange.new(
          begins_on: Date.parse('2017-10-01')
        )
        assert_equal expected_accounting_year, @calculator.accounting_year
      end
