...
class RequestForFlexibleWorkingTest < ActiveSupport::TestCase
  ...
  context "employee" do
    ...
    context "selecting 'under_17' and 'care_for_adult'" do
      should "show result 1 if 'under_17' and 'care_for_adult' selected" do
        ...
        assert_current_node :employee_no_right_to_apply
      end
    ...
    context "selecting 'under_17'" do
      ...
      should "ask if they are responible for the child" do
        assert_current_node :employee_responsible_for_childs_upbringing?
      end
      ...
      should "show result 2 if 'yes' selected" do
        add_response "yes"
        assert_current_node :employee_right_to_apply
      end
    end
    ...
    context "selecting 'care_for_adult'" do
      ...
      should "ask about the adult being cared for" do
        assert_current_node :employee_do_any_of_these_describe_the_adult_youre_caring_for?
      end
  ...
  context "employer" do
    ...
    context "selecting 'under_18' and 'care_for_adult'" do
      should "show result 1 if 'under_18' and 'care_for_adult' selected" do
        add_response "under_18,care_for_adult"
        assert_current_node :employer_no_right_to_apply
      end

      should "show result 1 if 'under_18', 'care_for_aduly', and 'less_than_26_weeks' selected" do
        add_response "under_18,care_for_adult,less_than_26_weeks"
        assert_current_node :employer_no_right_to_apply
      end
    end
    ...
    context "selecting 'under_18'" do
      setup do
        add_response "under_18"
      end

      should "ask if they are responible for the child" do
        assert_current_node :employer_responsible_for_childs_upbringing?
      end
      ...
      should "show result 2 if 'yes' selected" do
        add_response "yes"
        assert_current_node :employer_right_to_apply
      end
    end
    ...
    context "selecting 'care_for_adult'" do
      ...
      should "ask about the adult being cared for" do
        assert_current_node :employer_do_any_of_these_describe_the_adult_being_cared_for?
      end
