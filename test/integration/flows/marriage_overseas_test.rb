...
#testing for ceremony in france, france resident, british partner
  context "ceremony in france, resident in france, partner british" do
    ...
    should "go to cp or equivalent outcome" do
      assert_current_node :outcome_cp_france_pacs
      assert_phrase_list :france_pacs_law_cp_outcome, [:france_pacs_law_cp_all_intro, :france_pacs_law_cp_ceremony_france_local_resident, :france_pacs_law_cp_not_uk_resident, :france_pacs_law_cp_all_cp_what_you_need_to_do, :france_pacs_law_cp_not_uk_resident_two, :france_pacs_law_cp_all_celibacy_certificate, :france_pacs_law_cp_all_depositing_pacs_certificate, :france_pacs_law_cp_all_fees]
    end
  end
...
#testing for ceremony in united states, england resident, local partner
  context "ceremony in US, resident in ni, partner local" do
    ...
    should "go to cp no cni required outcome" do
      ...
      assert_phrase_list :no_cni_required_cp_outcome, [:"no_cni_required_cp_united-states", :no_cni_required_cp_uk_resident, :no_cni_required_cp_ceremony_us, :no_cni_required_all_what_you_need_to_do, :no_cni_required_cp_not_dutch_islands_uk_resident, :no_cni_required_cp_all_consular_facilities, :no_cni_required_cp_uk_resident_two, :no_cni_required_cp_all_depositing_certifictate, :no_cni_required_cp_ceremony_us_two, :no_cni_required_cp_uk_resident_three, :no_cni_required_cp_naturalisation, :no_cni_required_cp_all_fees]
    end
  end
#testing for ceremony in bonaire, england resident, other partner
  context "ceremony in bonaire, resident in scotland, partner other" do
    ...
    should "go to cp no cni required outcome" do
      assert_current_node :outcome_cp_no_cni
      assert_phrase_list :no_cni_required_cp_outcome, [:"no_cni_required_cp_bonaire-st-eustatius-saba", :no_cni_required_cp_uk_resident, :no_cni_required_all_what_you_need_to_do, :no_cni_required_cp_dutch_islands, :no_cni_required_cp_dutch_islands_uk_resident, :no_cni_required_cp_all_consular_facilities, :no_cni_required_cp_uk_resident_two, :no_cni_required_cp_all_depositing_certifictate, :no_cni_required_cp_ceremony_not_us, :no_cni_required_cp_uk_resident_three, :no_cni_required_cp_naturalisation, :no_cni_required_cp_all_fees]
    end
  end
#testing for ceremony in bonaire, bonaire resident, british partner
  context "ceremony in bonaire, resident in bonaire, partner british" do
    ...
    should "go to cp no cni required outcome" do
      assert_current_node :outcome_cp_no_cni
      assert_phrase_list :no_cni_required_cp_outcome, [:"no_cni_required_cp_bonaire-st-eustatius-saba", :no_cni_required_cp_not_uk_resident, :no_cni_required_all_what_you_need_to_do, :no_cni_required_cp_dutch_islands, :no_cni_required_cp_dutch_islands_local_resident, :no_cni_required_cp_all_consular_facilities, :no_cni_required_cp_all_depositing_certifictate, :no_cni_required_cp_ceremony_not_us, :no_cni_required_cp_all_fees]
    end
  end
#testing for ceremony in bonaire, other resident, irish partner
  context "ceremony in US, resident in mexico, partner other" do
    ...
    should "go to cp no cni required outcome" do
      assert_current_node :outcome_cp_no_cni
      assert_phrase_list :no_cni_required_cp_outcome, [:"no_cni_required_cp_bonaire-st-eustatius-saba", :no_cni_required_cp_not_uk_resident, :no_cni_required_all_what_you_need_to_do, :no_cni_required_cp_dutch_islands, :no_cni_required_cp_dutch_islands_other_resident, :no_cni_required_cp_all_consular_facilities, :no_cni_required_cp_all_depositing_certifictate, :no_cni_required_cp_ceremony_not_us, :no_cni_required_cp_naturalisation, :no_cni_required_cp_all_fees]
    end
  end
...
#testing for ceremony in australia, uk resident, irish partner
  context "ceremony in australia, resident in wales, partner irish" do
    ...
    should "go to cp commonwealth countries outcome" do
      ...
      assert_phrase_list :commonwealth_countries_cp_outcome, [:commonwealth_countries_cp_australia, :commonwealth_countries_cp_uk_resident, :commonwealth_countries_cp_australia_two, :commonwealth_countries_cp_uk_resident_two, :commonwealth_countries_cp_all_deposit_certificate, :commonwealth_countries_cp_australia_three, :commonwealth_countries_cp_uk_resident_three, :commonwealth_countries_cp_australia_four, :commonwealth_countries_cp_australia_five, :commonwealth_countries_cp_naturalisation, :commonwealth_countries_cp_australia_six]
    end
  end
#testing for ceremony in australia, australia resident, british partner
  context "ceremony in australia, resident in australia, partner british" do
    ...
    should "go to cp commonwealth countries outcome" do
      assert_current_node :outcome_cp_commonwealth_countries
      assert_phrase_list :commonwealth_countries_cp_outcome, [:commonwealth_countries_cp_australia, :commonwealth_countries_cp_not_uk_resident, :commonwealth_countries_cp_australia_two, :commonwealth_countries_cp_local_resident, :commonwealth_countries_cp_all_deposit_certificate, :commonwealth_countries_cp_australia_three, :commonwealth_countries_cp_australia_four, :commonwealth_countries_cp_australia_five, :commonwealth_countries_cp_australia_six]
    end
  end
#testing for ceremony in australia, other resident, local partner
  context "ceremony in australia, other resident, partner local" do
    ...
    should "go to cp commonwealth countries outcome" do
      assert_current_node :outcome_cp_commonwealth_countries
      assert_phrase_list :commonwealth_countries_cp_outcome, [:commonwealth_countries_cp_australia, :commonwealth_countries_cp_not_uk_resident, :commonwealth_countries_cp_australia_two, :commonwealth_countries_cp_other_resident, :commonwealth_countries_cp_all_deposit_certificate, :commonwealth_countries_cp_australia_three, :commonwealth_countries_cp_australia_four, :commonwealth_countries_cp_australia_partner_local, :commonwealth_countries_cp_australia_five, :commonwealth_countries_cp_naturalisation, :commonwealth_countries_cp_australia_six]
    end
  end
#testing for ceremony in canada, uk resident, other partner
  context "ceremony in canada, uk resident, partner other" do
    ...
    should "go to cp commonwealth countries outcome" do
      assert_current_node :outcome_cp_commonwealth_countries
      assert_phrase_list :commonwealth_countries_cp_outcome, [:commonwealth_countries_cp_canada, :commonwealth_countries_cp_uk_resident, :commonwealth_countries_cp_uk_resident_two, :commonwealth_countries_cp_all_deposit_certificate, :commonwealth_countries_cp_naturalisation]
    end
  end
