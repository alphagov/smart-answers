...
class WhatVisaToVisitUkTest < ActiveSupport::TestCase
  ...
  setup do
    @location_slugs = %w(brazil andorra china croatia anguilla south-africa turkey venezuela yemen oman united-arab-emirates qatar)
  ...
  # context "testing flow Brazil - all groupings but EEA" do
  #   setup do
  #     add_response "brazil"
  #   end
  #   should "ask for how long are you planning to stay" do
  #   assert_current_node :staying_for_how_long?
  # end
