...
class MarriageAbroadTest < ActiveSupport::TestCase
  ...
  FLATTEN_COUNTRIES_2_OUTCOMES = %w[australia croatia cyprus egypt france india ireland japan luxembourg philippines south-africa south-korea south-korea thailand turkey usa zimbabwe].freeze
