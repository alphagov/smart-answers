...
class CalculateYourHolidayEntitlementV2Test < ActiveSupport::TestCase
  include FlowTestHelper

  setup do
    setup_for_testing_flow 'calculate-your-holiday-entitlement-v2'
    @stubbed_calculator = SmartAnswer::Calculators::HolidayEntitlementV2.new
  end
