    ...
    class CalculatorTest < ActiveSupport::TestCase
      context "seeing if feb 29th in range" do
        should "return true for 2010-01-01 to 2012-05-05" do
          assert_equal true, Calculator.new.feb29th_in_range(Date.new(2010, 1, 1), Date.new(2012, 5, 5))
        end

        should "return true for 2012-01-01 to 2012-05-05" do
          assert_equal true, Calculator.new.feb29th_in_range(Date.new(2012, 1, 1), Date.new(2012, 5, 5))
        end

        should "return true for 2012-02-28 to 2012-03-01" do
          assert_equal true, Calculator.new.feb29th_in_range(Date.new(2012, 2, 28), Date.new(2012, 3, 1))
        end

        should "return true for 2012-02-29 to 2012-03-01" do
          assert_equal true, Calculator.new.feb29th_in_range(Date.new(2012, 2, 29), Date.new(2012, 3, 1))
        end

        should "return true for 1986-01-01 to 2010-05-04" do
          assert_equal true, Calculator.new.feb29th_in_range(Date.new(1986, 1, 1), Date.new(2012, 5, 4))
        end

        should "return true for 2011-12-31 to 2012-12-30" do
          assert_equal true, Calculator.new.feb29th_in_range(Date.new(2011, 12, 31), Date.new(2012,  12, 30))
        end

        should "return false for 2010-05-20 to 2011-04-03" do
          assert_equal false, Calculator.new.feb29th_in_range(Date.new(2010, 5, 20), Date.new(2011, 4, 3))
        end

        should "return false for 2012-03-01 to 2012-08-08" do
          assert_equal false, Calculator.new.feb29th_in_range(Date.new(2012, 3, 1), Date.new(2012, 8, 8))
        end

        should "return false for 2012-01-01 to 2012-02-02" do
          assert_equal false, Calculator.new.feb29th_in_range(Date.new(2012, 1, 1), Date.new(2012, 2, 2))
        end
      end
      ...
      context "calculating fraction of year" do
        ...
        context "with a start_date" do
          ...
          should "return the fraction of a year in a leap year not covering Feb 29th" do
            calc = Calculator.new(start_date: Date.parse('2012-03-01'))
        ...
        context "with a leaving_date" do
          should "return the fraction of a year" do
            calc = Calculator.new(leaving_date: Date.parse('2011-06-21'))
            assert_equal '0.4712', sprintf('%.4f', calc.fraction_of_year)
          end

          should "return the fraction of a year in a leap year" do
            calc = Calculator.new(leaving_date: Date.parse('2012-06-21'))
            assert_equal '0.4727', sprintf('%.4f', calc.fraction_of_year)
          end

          should "return the fraction of a year in a leap year not covering Feb 29th" do
            calc = Calculator.new(leaving_date: Date.parse('2012-01-21'))
        ...
        context "with a leave_year_start" do
          context "with a start date" do
            context "start date before leave_year_start" do
              should "return the fraction of a year" do
                calc = Calculator.new(start_date: Date.parse('2011-01-21'), leave_year_start_date: Date.parse('2011-02-01'))
                assert_equal '0.0301', sprintf('%.4f', calc.fraction_of_year)
              end

              should "return the fraction of a year in a leap year" do
                # 2011-12-31 to 2012-12-30
                calc = Calculator.new(start_date: Date.parse('2012-02-02'), leave_year_start_date: Date.parse('2012-12-31'))
                assert_equal '0.9098', sprintf('%.4f', calc.fraction_of_year)
              end

              should "return the fraction of a year in a leap year not covering Feb 29th" do
                calc = Calculator.new(start_date: Date.parse('2013-01-21'), leave_year_start_date: Date.parse('2013-02-01'))
                assert_equal '0.0301', sprintf('%.4f', calc.fraction_of_year)
              end
            ...
            context "start date after leave_year_start" do
              should "return the fraction of a year" do
                calc = Calculator.new(start_date: Date.parse('2011-04-21'), leave_year_start_date: Date.parse('2011-02-01'))
                assert_equal '0.7836', sprintf('%.4f', calc.fraction_of_year)
              end

              should "return the fraction of a year in a leap year" do
                calc = Calculator.new(start_date: Date.parse('2012-02-21'), leave_year_start_date: Date.parse('2012-02-01'))
                assert_equal '0.9454', sprintf('%.4f', calc.fraction_of_year)
              end

              should "return the fraction of a year in a leap year not covering Feb 29th" do
                calc = Calculator.new(start_date: Date.parse('2012-04-21'), leave_year_start_date: Date.parse('2012-02-01'))
          ...
          context "with a leave date" do
            context "leaving date before leave_year_start" do
              should "return the fraction of a year" do
                calc = Calculator.new(leaving_date: Date.parse('2011-01-21'), leave_year_start_date: Date.parse('2011-02-01'))
                assert_equal '0.9726', sprintf('%.4f', calc.fraction_of_year)
              end

              should "return the fraction of a year in a leap year" do
                calc = Calculator.new(leaving_date: Date.parse('2013-01-21'), leave_year_start_date: Date.parse('2013-02-01'))
                assert_equal '0.9727', sprintf('%.4f', calc.fraction_of_year)
              end

              should "return the fraction of a year in a leap year not covering Feb 29th" do
                calc = Calculator.new(leaving_date: Date.parse('2012-01-21'), leave_year_start_date: Date.parse('2012-03-01'))
            ...
            context "leaving date after leave_year_start" do
              should "return the fraction of a year" do
                calc = Calculator.new(leaving_date: Date.parse('2011-04-21'), leave_year_start_date: Date.parse('2011-02-01'))
                assert_equal '0.2192', sprintf('%.4f', calc.fraction_of_year)
              end

              should "return the fraction of a year in a leap year" do
                calc = Calculator.new(leaving_date: Date.parse('2012-04-21'), leave_year_start_date: Date.parse('2012-02-01'))
                assert_equal '0.2213', sprintf('%.4f', calc.fraction_of_year)
              end

              should "return the fraction of a year in a leap year not covering Feb 29th" do
                calc = Calculator.new(leaving_date: Date.parse('2012-02-21'), leave_year_start_date: Date.parse('2012-02-01'))
                assert_equal '0.0574', sprintf('%.4f', calc.fraction_of_year)
              end
      ...
      context "calculating casual or irregular hours entitlement" do
        should "return the hours and minutes of entitlement" do
          calc = Calculator.new(total_hours: 1314.4)
      ...
      context "calculating compressed hours entitlement" do
        should "return the hours and minutes of entitlement" do
          calc = Calculator.new(hours_per_week: 20.5, days_per_week: 3)
