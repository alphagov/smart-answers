...
module SmartAnswer::Calculators
  class StatePensionAmountCalculatorV2Test < ActiveSupport::TestCase
    ...
    context "female, born 7th April 1951, 39 qualifying years" do
      setup do
        @calculator = SmartAnswer::Calculators::StatePensionAmountCalculatorV2.new(gender: "female", dob: "1951-04-07", qualifying_years: "45")
      end
    ...
    context "female, born 7th April 1951, 20 qualifying years" do
      setup do
        @calculator = SmartAnswer::Calculators::StatePensionAmountCalculatorV2.new(gender: "female", dob: "1951-04-07", qualifying_years: "20")
      end

      should "be 20/30 of 107.45 for what_you_get" do
        assert_equal 73.43, @calculator.what_you_get
      end
    ...
    context "female, born 29th Feb 1968" do
      setup do
        @calculator = SmartAnswer::Calculators::StatePensionAmountCalculatorV2.new(gender: "female", dob: "1968-02-29", qualifying_years: nil)
      end
    ...
    context "female born 6 April 1992 " do
      setup do
        @calculator = SmartAnswer::Calculators::StatePensionAmountCalculatorV2.new(gender: "female", dob: "1992-04-06", qualifying_years: nil)
      end
    ...
    context "male born 6 April 1957 " do
      setup do
        @calculator = SmartAnswer::Calculators::StatePensionAmountCalculatorV2.new(gender: "female", dob: "1957-04-06", qualifying_years: nil)
      end
    ...
    context "female born 22 years ago" do
      should "return ni_years_to_date = 3" do
        ...
        @calculator = SmartAnswer::Calculators::StatePensionAmountCalculatorV2.new(gender: "female", dob: dob, qualifying_years: nil)
    ...
    context "test available years functions" do
      ...
      context "testing what would get if not enough time to get full state pension" do
        should "state that user has 13 remaining years and would get 2/3 of basic pension" do
          Timecop.travel(Date.parse("2012-10-09")) do
            @calculator = SmartAnswer::Calculators::StatePensionAmountCalculatorV2.new(
              gender: "male", dob: "1960-04-04", qualifying_years: 7)
            assert_equal 13, @calculator.years_to_pension
            assert_equal 73.43, @calculator.what_you_would_get_if_not_full
          end
        end
      end
