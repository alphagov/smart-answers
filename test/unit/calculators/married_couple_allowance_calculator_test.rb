...
module SmartAnswer::Calculators
  class MarriedCouplesAllowanceCalculatorTest < ActiveSupport::TestCase
    ...
    test "rate values for 2026/27" do
      travel_to("2026-06-01") do
        calculator = MarriedCouplesAllowanceCalculator.new

        assert_equal 12_570, calculator.personal_allowance
        assert_equal 39_200.0, calculator.income_limit_for_personal_allowances
        assert_equal 11_700, calculator.maximum_mca
        assert_equal 4530, calculator.minimum_mca
      end
    end
  end
end
