    ...
    context MaternityPaternityCalculatorV2 do
      ...
      context "specific date tests (for lower_earning_limits) for adoption" do
        should "return lower_earning_limit 107" do
          ...
          @calculator = MaternityPaternityCalculatorV2.new(@match_date, MaternityPaternityCalculatorV2::LEAVE_TYPE_ADOPTION)
          assert_equal @calculator.lower_earning_limit, 107
        end
      ...
      context "adoption employment start tests" do
        ...
        should "matched_date Monday 28th May 2012" do
          ...
          @calculator = MaternityPaternityCalculatorV2.new(@matched_date, MaternityPaternityCalculatorV2::LEAVE_TYPE_ADOPTION)
      ...
      context "pay dates for pay method from 12 August 2012" do
        ...
        should "calculate last working day of the month pay dates" do
          ...
          assert_equal '2012-07-25', paydates.first.to_s
          assert_equal '2012-08-29', paydates.second.to_s
          assert_equal '2012-09-26', paydates.third.to_s
          assert_equal '2013-04-24', paydates.last.to_s
        end
      ...
      context "paydates and pay" do
        ...
        should "calculate pay due for each pay date on a bi-weekly cycle" do
          ...
          assert_equal '2013-04-25', uprated_payments.first[:date].to_s
          assert_equal '2013-10-10', paydates_and_pay.last[:date].to_s
        end
