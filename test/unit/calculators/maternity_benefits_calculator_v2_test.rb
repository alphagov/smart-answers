  ...
  class MaternityBenefitsCalculatorV2Test < ActiveSupport::TestCase
  	context MaternityBenefitsCalculatorV2 do 
  		context "basic tests" do
		      ...
		      @calculator = MaternityBenefitsCalculatorV2.new(@due_date)
		    end
    ...
    context "uprating calculations" do
      context "before 7th April 2013" do
        setup do
          @calculator = MaternityBenefitsCalculatorV2.new(Date.parse("5th April 2013"))
        end
      ...
      context "after 7th April 2013" do
        setup do
          @calculator = MaternityBenefitsCalculatorV2.new(Date.parse("8th April 2013"))
        end
      ...
      context "after 14th July 2013" do
        setup do
          @calculator = MaternityBenefitsCalculatorV2.new(Date.parse("14th July 2013"))
        end
    ...
    context "eleven_weeks" do
      should "work out earliest date maternity allowance payments can start" do
        calculator = MaternityBenefitsCalculatorV2.new(Date.parse("1st April 2013"))
