    ...
    class OverseasPassportsCalculatorTest < ActiveSupport::TestCase
      ...
      context '#world_location' do
        ...
        context '#supporting_documents' do
          ...
          should 'return application_group for the current_location with birth_location is blank' do
          ...
          should 'return application_group for birth_location is birth_location is present and not united-kingdom' do
