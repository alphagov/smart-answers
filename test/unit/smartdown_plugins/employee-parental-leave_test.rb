...
module SmartdownPlugins
  class EmployeeParentalLeaveTest < ActiveSupport::TestCase
    test "claim_date_maternity_allowance returns a date 14 weeks before given date" do
      ...
      expected = Smartdown::Model::Answer::Date.new(:question, "2013-9-25")
    ...
    test "earliest_start returns a date 14 days after the given placement_date" do
      placement_date = Smartdown::Model::Answer::Date.new(:question, "2014-1-1")
      expected = Smartdown::Model::Answer::Date.new(:question, "2013-12-18")
    ...
    test "end_of_additional_leave returns a date 52 weeks after the given date_leave_1" do
      date_leave_1 = Smartdown::Model::Answer::Date.new(:question, "2014-1-1")
      expected = Smartdown::Model::Answer::Date.new(:question, "2014-12-31")
    ...
    test "end_of_additional_paternity_leave returns a date 1 year after the given date" do
      date = Smartdown::Model::Answer::Date.new(:question, "2014-1-1")
      expected = Smartdown::Model::Answer::Date.new(:question, "2015-1-1")
    ...
    test "end_of_maternity_allowance returns a date 28 weeks after the given date" do
      date = Smartdown::Model::Answer::Date.new(:question, "2014-1-1")
      expected = Smartdown::Model::Answer::Date.new(:question, "2014-7-16")
    ...
    test "end_of_additional_paternity_pay_from_due_date returns a date 28 weeks after the given date" do
      date = Smartdown::Model::Answer::Date.new(:question, "2014-1-1")
      expected = Smartdown::Model::Answer::Date.new(:question, "2014-7-16")
      assert_equal expected, SmartdownPlugins::EmployeeParentalLeave.end_of_additional_paternity_pay_from_due_date(date)
    end

    test "end_of_additional_paternity_pay_from_match_date" do
      pending "end_of_additional_paternity_pay_from_match_date undefined"
    end

    test "end_of_14_week_maternity_allowance returns a date 14 weeks after the given date" do
      date = Smartdown::Model::Answer::Date.new(:question, "2014-1-1")
      expected = Smartdown::Model::Answer::Date.new(:question, "2014-4-9")
    ...
    test "end_of_maternity_pay returns a date 39 weeks after the given date" do
      date = Smartdown::Model::Answer::Date.new(:question, "2014-1-1")
      expected = Smartdown::Model::Answer::Date.new(:question, "2014-10-1")
    ...
    test "end_of_ordinary_leave returns a date 26 weeks after the given date_leave_1" do
      date_leave_1 = Smartdown::Model::Answer::Date.new(:question, "2014-1-1")
      expected = Smartdown::Model::Answer::Date.new(:question, "2014-7-2")
    ...
    test "latest_pat_leave returns a date 56 days after the given date" do
      date = Smartdown::Model::Answer::Date.new(:question, "2014-1-1")
      expected = Smartdown::Model::Answer::Date.new(:question, "2014-2-26")
    ...
    test "notice_date_sap returns a date 28 days before the given date_leave_1" do
      date = Smartdown::Model::Answer::Date.new(:question, "2014-1-1")
      expected = Smartdown::Model::Answer::Date.new(:question, "2013-12-4")
    ...
    test "paternity_leave_notice_date returns a date 15 weeks before the Monday before the given date" do
      date = Smartdown::Model::Answer::Date.new(:question, "2014-9-25") # A Thursday
      expected = Smartdown::Model::Answer::Date.new(:question, "2014-6-9") # A Monday, 15 weeks before Monday 2014-9-22.
    ...
    test "qualifying_week returns a date 7 days after the given match_date" do
      match_date = Smartdown::Model::Answer::Date.new(:question, "2014-1-1")
      expected = Smartdown::Model::Answer::Date.new(:question, "2014-1-8")
    ...
    test "rate_of_paternity_pay returns 138.18 when 90% of the given weekly salary is higher than £138.18" do
      salary_2 = Smartdown::Model::Answer::Salary.new(:question, "200-week")
    ...
    test "rate_of_paternity_pay returns 90% of the given weekly salary when it is less than £138.18" do
      salary_2 = Smartdown::Model::Answer::Salary.new(:question, "150-week")
    ...
    test "rate_of_maternity_allowance returns 138.18 when 90% of the given weekly salary is higher than £138.18" do
      salary_1 = Smartdown::Model::Answer::Salary.new(:question, "200-week")
    ...
    test "rate_of_maternity_allowance returns 90% of the given weekly salary when it is less than £138.18" do
      salary_1 = Smartdown::Model::Answer::Salary.new(:question, "150-week")
    ...
    test "start_of_additional_leave returns a date 26 weeks and 1 day after the given date_leave_1" do
      date_leave_1 = Smartdown::Model::Answer::Date.new(:question, "2014-1-1")
      expected = Smartdown::Model::Answer::Date.new(:question, "2014-7-3")
    ...
    test "start_of_additional_paternity_leave returns a date 20 weeks after the given date" do
      date = Smartdown::Model::Answer::Date.new(:question, "2014-1-1")
      expected = Smartdown::Model::Answer::Date.new(:question, "2014-5-21")
    ...
    test "start_of_maternity_allowance returns a date 11 weeks before the given date" do
      date = Smartdown::Model::Answer::Date.new(:question, "2014-1-1")
      expected = Smartdown::Model::Answer::Date.new(:question, "2013-10-16")
