...
module SmartdownPlugins
  ...
  class EmployeeParentalLeaveTest < ActiveSupport::TestCase
    ...
    test "earnings_test_start_date returns a date 66 weeks before given date" do
      placement_date = Smartdown::Model::Answer::Date.new(:question, "2014-1-1")
      expected = Smartdown::Model::Answer::Date.new(:question, "2012-9-26")
    ...
    test "minimum_start_date returns a date 41 weeks before the given date" do
      date = Smartdown::Model::Answer::Date.new(:question, "2014-1-1")
      expected = Smartdown::Model::Answer::Date.new(:question, "2013-3-20")
    ...
    test "minimum_end_date returns a date 15 weeks before the given date" do
      date = Smartdown::Model::Answer::Date.new(:question, "2014-1-1")
      expected = Smartdown::Model::Answer::Date.new(:question, "2013-9-18")
