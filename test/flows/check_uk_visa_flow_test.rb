...
class CheckUkVisaFlowTest < ActiveSupport::TestCase
  ...
  context "outcome: outcome_study_y" do
    ...
    should "not render student visa ineligibility message when not applicable" do
      ...
      assert_no_rendered_outcome text: "You cannot apply for a Student visa if you are a national of Myanmar"
    end
  ...
  context "outcome: outcome_work_m" do
    ...
    should "render skilled worker visa ineligibility message when applicable" do
      ...
      assert_rendered_outcome text: "You cannot apply for a Skilled Worker visa if you are a national of Afghanistan"
    end

    should "not render skilled worker visa ineligibility message when not applicable" do
      add_responses what_passport_do_you_have?: "china"

      assert_no_rendered_outcome text: "You cannot apply for a Skilled Worker visa if you are a national of Afghanistan"
    end
  end
