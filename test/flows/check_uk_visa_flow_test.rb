...
class CheckUkVisaFlowTest < ActiveSupport::TestCase
  ...
  context "question: what_passport_do_you_have?" do
    ...
    context "next_node" do
      should "have a next node of dual_british_or_irish_citizenship? with a non-'ireland' passport" do
        assert_next_node :dual_british_or_irish_citizenship?, for_response: "china"
      end

      should "have a next node of outcome_no_visa_needed_ireland with an 'ireland' passport" do
