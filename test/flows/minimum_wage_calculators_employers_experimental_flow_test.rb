...
require "support/minimum_wage_flow_test_helper"

require "smart_answer_flows/minimum-wage-calculator-employers"

class MinimumWageCalculatorEmployersExperimentalFlowTest < ActiveSupport::TestCase
  include ExperimentalFlowTestHelper
  extend MinimumWageFlowTestHelper

  setup do
    testing_flow SmartAnswer::MinimumWageCalculatorEmployersFlow
    @living_wage_age = "25"
  end
