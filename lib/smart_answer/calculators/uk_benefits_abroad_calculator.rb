module SmartAnswer::Calculators
  class UkBenefitsAbroadCalculator
    ...
    attr_accessor :country, :country_name, :benefits, :dispute_criteria, :partner_premiums, :possible_impairments, :impairment_periods, :tax_credits, :going_abroad, :benefit
