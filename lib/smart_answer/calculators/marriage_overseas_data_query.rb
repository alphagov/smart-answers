module SmartAnswer::Calculators
  class MarriageOverseasDataQuery
    ...
    BRITISH_OVERSEAS_TERRITORIES = %(anguilla bermuda british-antarctic-territory british-indian-ocean-territory british-virgin-islands cayman-islands falkland-islands gibraltar montserrat pitcairn st-helena south-georgia-and-south-sandwich-islands turks-and-caicos-islands)
    ...
    FRENCH_OVERSEAS_TERRITORIES = %(french-guiana french-polynesia guadeloupe martinique mayotte new-caledonia reunion st-pierre-and-miquelon wallis-and-futuna)
