module SmartAnswer::Calculators
  class MarriageAbroadDataQuery
    ...
    THREE_DAY_RESIDENCY_REQUIREMENT_COUNTRIES = %w(albania angola armenia austria bahrain bolivia bosnia-and-herzegovina bulgaria croatia cuba democratic-republic-of-the-congo denmark dominican-republic estonia ethiopia georgia guatemala honduras iceland kazakhstan kosovo kuwait kyrgyzstan lithuania luxembourg macedonia mexico montenegro nepal panama russia serbia slovenia sudan tajikistan tunisia turkmenistan ukraine uzbekistan venezuela).freeze
