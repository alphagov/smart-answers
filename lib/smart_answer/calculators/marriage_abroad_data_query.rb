module SmartAnswer::Calculators
  class MarriageAbroadDataQuery
    ...
    OS_AFFIRMATION_COUNTRIES = %w(belgium cambodia colombia ecuador egypt lebanon finland macao mongolia morocco norway peru qatar south-korea thailand turkey united-arab-emirates vietnam)
