module SmartAnswer::Calculators
  class CheckBenefitsFinancialSupportCalculator
    ...
    def eligible_for_funded_early_learning_and_childcare?
      @children_living_with_you == "yes" && eligible_child_ages?(%w[2 3_to_4 5_to_7])
    end
    ...
    def eligible_for_pension_age_winter_heating_payment?
      @over_state_pension_age == "yes"
    end
    ...
    def eligible_for_child_winter_heating_payment?
      @children_with_disability == "yes"
    end
