module SmartAnswer::Calculators
  class CheckBenefitsFinancialSupportCalculator
    ...
    def eligible_for_maternity_allowance?
      ...
      @over_state_pension_age == "no" && eligible_child_ages
    ...
    def eligible_for_free_tv_license?
      ...
      skip_benefit_list = %w[pension_credit]

      @on_benefits == "no" || permitted_benefits?(skip_benefit_list)
    end
    ...
    def eligible_for_tax_free_childcare?
      return if @are_you_working == "no" || @children_living_with_you == "no"
