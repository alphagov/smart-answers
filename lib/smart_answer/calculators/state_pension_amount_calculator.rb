  ...
  class StatePensionAmountCalculator
    ...
    def what_you_get_raw
      if qualifying_years < years_needed
        BigDecimal.new(qualifying_years.to_s) / BigDecimal.new(years_needed.to_s) * current_weekly_rate
      else
        current_weekly_rate
      end
    end
    ...
    def what_you_would_get_if_not_full
      if (qualifying_years + years_to_pension) < years_needed
        BigDecimal.new((qualifying_years + years_to_pension).to_s) / BigDecimal.new(years_needed.to_s) * current_weekly_rate
      else
        current_weekly_rate
      end
    end
