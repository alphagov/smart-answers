module SmartAnswer::Calculators
  class PayLeaveForParentsCalculator
    ...
    attr_accessor :two_carers, :due_date, :employment_status_of_mother, :employment_status_of_partner, :mother_started_working_before_continuity_start_date, :mother_still_working_on_continuity_end_date, :mother_earned_more_than_lower_earnings_limit, :mother_worked_at_least_26_weeks, :mother_earned_at_least_390, :partner_started_working_before_continuity_start_date, :partner_still_working_on_continuity_end_date, :partner_earned_more_than_lower_earnings_limit, :partner_worked_at_least_26_weeks, :partner_earned_at_least_390
