...
outcome :ips_application_result do
  ...
  precalculate :cost do
    uk_visa_application_centre_countries = %w(algeria azerbaijan china georgia indonesia kazakhstan laos lebanon mauritania morocco nepal ukraine)
  ...
  precalculate :send_your_application do
    uk_visa_application_centre_countries = %w(afghanistan algeria azerbaijan burundi china georgia indonesia kazakhstan laos lebanon mauritania morocco nepal ukraine)
  ...
  precalculate :getting_your_passport do
    ...
    uk_visa_application_centre_countries = %w(algeria azerbaijan china georgia indonesia kazakhstan laos lebanon mauritania morocco ukraine)
