...
outcome :outcome_os_consular_cni do
  precalculate :consular_cni_os_start do
    ...
    if ceremony_country == residency_country and %w(croatia germany italy japan spain).exclude?(ceremony_country) and cni_posted_after_7_days_countries.include?(ceremony_country)
    ...
    if ceremony_country == residency_country
      ...
      if cni_notary_public_countries.include?(ceremony_country) or ceremony_country == 'italy' or ceremony_country == 'spain' or ceremony_country == 'japan' or ceremony_country == 'macedonia'
        phrases << :consular_cni_os_download_documents_notary_public
