module SmartAnswer
  class BusinessCoronavirusRiskAssessmentFlow < Flow
    def define
      name "business-coronavirus-risk-assessment"
      ...
      checkbox_question :sectors? do
        ...
        on_response do |response|
          self.calculator = Calculators::BusinessCoronavirusRiskAssessmentCalculator.new
