    ...
    def define
      ...
      multiple_choice :mother_earned_more_than_lower_earnings_limit do
        ...
        next_node do |response|
          if calculator.continuity(calculator.mother_started_working_before_continuity_start_date, calculator.mother_still_working_on_continuity_end_date) && calculator.lower_earnings(response)
            if calculator.two_carers == 'no'
        ...
        next_node do |response|
          if calculator.employment_status_of_partner == 'employee'
            if calculator.continuity(partner_started_working_before_continuity_start_date, partner_still_working_on_continuity_end_date) && calculator.lower_earnings(response)
              if calculator.employment_status_of_mother == 'employee'
                if calculator.continuity(calculator.mother_started_working_before_continuity_start_date, calculator.mother_still_working_on_continuity_end_date) && calculator.lower_earnings(mother_earned_more_than_lower_earnings_limit)
                  if calculator.due_date >= Date.parse('2015-04-05')
                ...
                elsif !calculator.continuity(calculator.mother_started_working_before_continuity_start_date, calculator.mother_still_working_on_continuity_end_date) || !calculator.lower_earnings(mother_earned_more_than_lower_earnings_limit)
                  if calculator.due_date >= Date.parse('2015-04-05')
                    if calculator.earnings_employment(mother_earned_at_least_390, mother_worked_at_least_26_weeks)
                      outcome :outcome_mat_allowance_pat_leave_pat_pay_pat_shared_leave_pat_shared_pay
                    elsif !calculator.earnings_employment(mother_earned_at_least_390, mother_worked_at_least_26_weeks)
