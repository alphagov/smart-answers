    ...
    radio :marriage_or_civil_partnership? do
      ...
      next_node do |response|
        ...
        when "civil_partnership"
          ...
          when "japan"
            outcome :outcome_opposite_sex_civil_partnership_in_japan
          when "vietnam"
            outcome :outcome_opposite_sex_civil_partnership_in_vietnam
          when "panama"
            outcome :outcome_opposite_sex_civil_partnership_in_panama
          end
        end
      end
    end
